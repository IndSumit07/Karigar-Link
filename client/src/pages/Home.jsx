...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-yellow-50 relative overflow-hidden">
      ...
      <section className="py-24 bg-white relative z-10 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto animate-slideInUp" style={{ animationDelay: '0.1s' }}>
              Get your work done in three simple steps with our trusted network of skilled professionals
            </p>
          </div>
          
          <div className="relative">
            {/* Connection Lines */}
            <div className="hidden lg:block absolute top-1/2 left-12 right-12 h-0.5 bg-gradient-to-r from-orange-300 via-yellow-400 to-orange-300 transform -translate-y-1/2 animate-slideInUp" style={{ animationDelay: '0.8s' }} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <div key={index} className="relative group animate-slideInUp" style={{ animationDelay: `${index * 0.2 + 0.4}s` }}>
                  {/* Card */}
                  ...
                  {index < 3 && (
                    <div className="lg:hidden flex justify-center mt-6 mb-6">
                      ...
                      <div className="w-2 h-2 bg-orange-300 rounded-full mx-2 animate-pulse" style={{ animationDelay: '0.2s' }} />
          ...
          {/* Call to Action */}
          <div className="text-center mt-16 animate-slideInUp" style={{ animationDelay: '1s' }}>
            <Link
              to="/register"
      ...
      <section className="py-24 relative z-10 overflow-hidden" style={{ backgroundColor: '#f5be67' }}>
        ...
        <div className="max-w-6xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <h2 className="text-5xl md:text-6xl font-bold text-white mb-6 animate-slideInUp" style={{ animationDelay: '0.1s' }}>
            Ready to Get <span className="text-white drop-shadow-lg">Started?</span>
          </h2>
          
          <p className="text-xl md:text-2xl text-white opacity-95 mb-12 max-w-3xl mx-auto leading-relaxed animate-slideInUp" style={{ animationDelay: '0.2s' }}>
            Join thousands of satisfied customers and skilled artisans in our growing marketplace
          </p>
          
          {/* Stats */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 animate-slideInUp" style={{ animationDelay: '0.3s' }}>
          ...
          {/* Trust Indicators */}
          <div className="mt-12 flex flex-wrap justify-center items-center gap-8 opacity-80 animate-slideInUp" style={{ animationDelay: '0.5s' }}>
